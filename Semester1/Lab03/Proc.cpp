...
{
    if(task_num == 1)
		Task_name -> Caption = "ќпределить, равны ли количества положительных и отрицательных чисел в каждой строке.";
	if(task_num == 2)
		Task_name -> Caption = "—формировать одномерный массив из сумм отрицательных элементов в каждой строке.";
}
//---------------------------------------------------------------------------
...
{
    if(task_num == 1){
		//ќпределить, равны ли количества положительных и отрицательных чисел в каждой строке.
	...
	if(task_num == 2){
		//—формировать одномерный массив из сумм отрицательных элементов в каждой строке.
		for (int i = 0; i < SG1 -> RowCount; i++) {
			int sum = 0;
			for(int j = 0; j < SG1 -> ColCount; j++){
